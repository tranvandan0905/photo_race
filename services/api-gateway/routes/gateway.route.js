...
const { postsubmission, getsubmission, FindsubTopic, deletesubmission } = require('../controllers/submission.getway');
...
const { getUser, findUser, deleteUser, updateUser, findUserById, patchVoteXu, postUser, findNameUser,
    updateAvataUser, resetpassword, verifyForgotPassword } = require("../controllers/user.gateway");
...
const { PostAdvertiser, GetAdvertisers, DeleteAdvertiser, GetAds, GetAdsByAdvertiser,
    GetActiveAds, UpdateAds, Updateadver, FindverID, GetPaymentByAdvertiser } = require("../controllers/ad.getway");
const { bankingMoMo, getdepositRequet, gettwithdrawRequet, bankingMoMoAds } = require("../controllers/banking.getway");
const {validateEmail, validatefindNameUser, validateupdateAvataUser,validateID_user, validatecreateUser} = require("../middlewares/validate.middleware");
// Submission 
...
routeAPI.patch('/user/vote/:id',validateID_user, patchVoteXu);
routeAPI.post('/email-password',validateEmail, resetpassword);
